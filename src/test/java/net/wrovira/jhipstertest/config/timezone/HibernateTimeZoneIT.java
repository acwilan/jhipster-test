package net.wrovira.jhipstertest.config.timezone;
...
import net.wrovira.jhipstertest.repository.timezone.DateTimeWrapper;
import net.wrovira.jhipstertest.repository.timezone.DateTimeWrapperRepository;
