...
import net.wrovira.jhipstertest.config.audit.AuditEventConverter;
import net.wrovira.jhipstertest.domain.PersistentAuditEvent;
import net.wrovira.jhipstertest.repository.PersistenceAuditEventRepository;
import net.wrovira.jhipstertest.security.AuthoritiesConstants;
import net.wrovira.jhipstertest.service.AuditEventService;
