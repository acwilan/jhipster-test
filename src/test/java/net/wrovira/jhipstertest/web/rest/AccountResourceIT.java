package net.wrovira.jhipstertest.web.rest;

import static net.wrovira.jhipstertest.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.wrovira.jhipstertest.JHipsterTestApp;
import net.wrovira.jhipstertest.config.Constants;
import net.wrovira.jhipstertest.domain.Authority;
import net.wrovira.jhipstertest.domain.User;
import net.wrovira.jhipstertest.repository.AuthorityRepository;
import net.wrovira.jhipstertest.repository.UserRepository;
import net.wrovira.jhipstertest.security.AuthoritiesConstants;
import net.wrovira.jhipstertest.service.UserService;
import net.wrovira.jhipstertest.service.dto.PasswordChangeDTO;
import net.wrovira.jhipstertest.service.dto.UserDTO;
import net.wrovira.jhipstertest.web.rest.vm.KeyAndPasswordVM;
import net.wrovira.jhipstertest.web.rest.vm.ManagedUserVM;
