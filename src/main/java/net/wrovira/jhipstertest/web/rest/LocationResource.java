...
import net.wrovira.jhipstertest.domain.Location;
import net.wrovira.jhipstertest.service.LocationService;
...
/**
 * REST controller for managing {@link net.wrovira.jhipstertest.domain.Location}.
 */
@RestController
@RequestMapping("/api")
