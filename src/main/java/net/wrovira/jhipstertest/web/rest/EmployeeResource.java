...
import net.wrovira.jhipstertest.domain.Employee;
import net.wrovira.jhipstertest.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link net.wrovira.jhipstertest.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
