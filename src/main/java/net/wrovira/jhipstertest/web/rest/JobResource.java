...
import net.wrovira.jhipstertest.domain.Job;
import net.wrovira.jhipstertest.repository.JobRepository;
...
/**
 * REST controller for managing {@link net.wrovira.jhipstertest.domain.Job}.
 */
@RestController
@RequestMapping("/api")
@Transactional
