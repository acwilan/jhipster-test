...
import net.wrovira.jhipstertest.domain.Department;
import net.wrovira.jhipstertest.service.DepartmentService;
...
/**
 * REST controller for managing {@link net.wrovira.jhipstertest.domain.Department}.
 */
@RestController
@RequestMapping("/api")
