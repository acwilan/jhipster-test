...
import net.wrovira.jhipstertest.domain.Region;
import net.wrovira.jhipstertest.service.RegionService;
...
/**
 * REST controller for managing {@link net.wrovira.jhipstertest.domain.Region}.
 */
@RestController
@RequestMapping("/api")
