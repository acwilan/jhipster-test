...
import net.wrovira.jhipstertest.domain.Task;
import net.wrovira.jhipstertest.service.TaskService;
...
/**
 * REST controller for managing {@link net.wrovira.jhipstertest.domain.Task}.
 */
@RestController
@RequestMapping("/api")
